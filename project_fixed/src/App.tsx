...
import { apiBrainstorm, apiGeneratePrompts } from './apiService';
...
export default function App() {
  ...
  const handleGenerate = async () => {
    ...
    setPrompts(null);
    try {
      const data = await apiGeneratePrompts(idea, settings, aiConfig);
      setPrompts(data);
  ...
  const handleBrainstorm = async () => {
    ...
    try {
      const result = await apiBrainstorm(idea, aiConfig);
